...
func (c *Client) GetFinalizedBlocks(ctx context.Context) (_ Queries_GetFinalizedBlocksClient, err error) {
	stream, err := c.grpcClient.GetFinalizedBlocks(ctx, new(Empty))
	if err != nil {
