...
const (
	...
	Queries_GetScheduledReleaseAccounts_FullMethodName        = "/concordium.v2.Queries/GetScheduledReleaseAccounts"
	Queries_GetCooldownAccounts_FullMethodName                = "/concordium.v2.Queries/GetCooldownAccounts"
	Queries_GetPreCooldownAccounts_FullMethodName             = "/concordium.v2.Queries/GetPreCooldownAccounts"
	Queries_GetPrePreCooldownAccounts_FullMethodName          = "/concordium.v2.Queries/GetPrePreCooldownAccounts"
	...
	Queries_GetConsensusDetailedStatus_FullMethodName         = "/concordium.v2.Queries/GetConsensusDetailedStatus"
...
type QueriesClient interface {
	...
	GetScheduledReleaseAccounts(ctx context.Context, in *BlockHashInput, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AccountPending], error)
	...
	GetCooldownAccounts(ctx context.Context, in *BlockHashInput, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AccountPending], error)
	// Get all accounts that have stake in pre-cooldown.
	// (This only identifies accounts by index.)
	// Prior to protocol version 7, the resulting stream will always be empty.
	GetPreCooldownAccounts(ctx context.Context, in *BlockHashInput, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AccountIndex], error)
	// Get all accounts that have stake in pre-pre-cooldown.
	// (This only identifies accounts by index.)
	// Prior to protocol version 7, the resulting stream will always be empty.
	GetPrePreCooldownAccounts(ctx context.Context, in *BlockHashInput, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AccountIndex], error)
	...
	//   - `UNIMPLEMENTED` if the endpoint is disabled on the node.
	GetConsensusDetailedStatus(ctx context.Context, in *ConsensusDetailedStatusQuery, opts ...grpc.CallOption) (*ConsensusDetailedStatus, error)
...
func (c *queriesClient) GetScheduledReleaseAccounts(ctx context.Context, in *BlockHashInput, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AccountPending], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Queries_ServiceDesc.Streams[18], Queries_GetScheduledReleaseAccounts_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[BlockHashInput, AccountPending]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Queries_GetScheduledReleaseAccountsClient = grpc.ServerStreamingClient[AccountPending]

func (c *queriesClient) GetCooldownAccounts(ctx context.Context, in *BlockHashInput, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AccountPending], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Queries_ServiceDesc.Streams[19], Queries_GetCooldownAccounts_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[BlockHashInput, AccountPending]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Queries_GetCooldownAccountsClient = grpc.ServerStreamingClient[AccountPending]

func (c *queriesClient) GetPreCooldownAccounts(ctx context.Context, in *BlockHashInput, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AccountIndex], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Queries_ServiceDesc.Streams[20], Queries_GetPreCooldownAccounts_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[BlockHashInput, AccountIndex]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Queries_GetPreCooldownAccountsClient = grpc.ServerStreamingClient[AccountIndex]

func (c *queriesClient) GetPrePreCooldownAccounts(ctx context.Context, in *BlockHashInput, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AccountIndex], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Queries_ServiceDesc.Streams[21], Queries_GetPrePreCooldownAccounts_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[BlockHashInput, AccountIndex]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Queries_GetPrePreCooldownAccountsClient = grpc.ServerStreamingClient[AccountIndex]
...
func (c *queriesClient) GetBlockItems(ctx context.Context, in *BlockHashInput, opts ...grpc.CallOption) (grpc.ServerStreamingClient[BlockItem], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Queries_ServiceDesc.Streams[22], Queries_GetBlockItems_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *queriesClient) GetBakersRewardPeriod(ctx context.Context, in *BlockHashInput, opts ...grpc.CallOption) (grpc.ServerStreamingClient[BakerRewardPeriodInfo], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Queries_ServiceDesc.Streams[23], Queries_GetBakersRewardPeriod_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *queriesClient) GetConsensusDetailedStatus(ctx context.Context, in *ConsensusDetailedStatusQuery, opts ...grpc.CallOption) (*ConsensusDetailedStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConsensusDetailedStatus)
	err := c.cc.Invoke(ctx, Queries_GetConsensusDetailedStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queriesClient) DryRun(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[DryRunRequest, DryRunResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Queries_ServiceDesc.Streams[25], Queries_DryRun_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type QueriesServer interface {
	...
	// scheduled release for that account. (Note, this only identifies accounts by index, and
	// only indicates the first pending release for each account.)
	GetScheduledReleaseAccounts(*BlockHashInput, grpc.ServerStreamingServer[AccountPending]) error
	// Get all accounts that have stake in cooldown, with the timestamp of the first pending
	// cooldown expiry for each account. (Note, this only identifies accounts by index,
	// and only indicates the first pending cooldown for each account.)
	// Prior to protocol version 7, the resulting stream will always be empty.
	GetCooldownAccounts(*BlockHashInput, grpc.ServerStreamingServer[AccountPending]) error
	// Get all accounts that have stake in pre-cooldown.
	// (This only identifies accounts by index.)
	// Prior to protocol version 7, the resulting stream will always be empty.
	GetPreCooldownAccounts(*BlockHashInput, grpc.ServerStreamingServer[AccountIndex]) error
	// Get all accounts that have stake in pre-pre-cooldown.
	// (This only identifies accounts by index.)
	// Prior to protocol version 7, the resulting stream will always be empty.
	GetPrePreCooldownAccounts(*BlockHashInput, grpc.ServerStreamingServer[AccountIndex]) error
	// Get the projected earliest time at which a particular baker will be required to bake a block.
	// If the current consensus version is 0, this returns the status 'Unavailable', as the endpoint
	// is only supported by consensus version 1.
	//
	...
	//   - `INVALID_ARGUMENT` if the query specifies a genesis index at consensus version 0.
	//   - `UNIMPLEMENTED` if the endpoint is disabled on the node.
	GetConsensusDetailedStatus(context.Context, *ConsensusDetailedStatusQuery) (*ConsensusDetailedStatus, error)
	// Dry run a series of transactions and operations on a state derived from a specified block.
	// The server should send a single `DryRunResponse` for each `DryRunRequest` received, unless
	// the call fails with an error status code. If a request produces a `DryRunErrorResponse`, then
	// the server will still process subsequent requests, just as if the request causing the error
...
func (UnimplementedQueriesServer) GetScheduledReleaseAccounts(*BlockHashInput, grpc.ServerStreamingServer[AccountPending]) error {
	return status.Errorf(codes.Unimplemented, "method GetScheduledReleaseAccounts not implemented")
}
func (UnimplementedQueriesServer) GetCooldownAccounts(*BlockHashInput, grpc.ServerStreamingServer[AccountPending]) error {
	return status.Errorf(codes.Unimplemented, "method GetCooldownAccounts not implemented")
}
func (UnimplementedQueriesServer) GetPreCooldownAccounts(*BlockHashInput, grpc.ServerStreamingServer[AccountIndex]) error {
	return status.Errorf(codes.Unimplemented, "method GetPreCooldownAccounts not implemented")
}
func (UnimplementedQueriesServer) GetPrePreCooldownAccounts(*BlockHashInput, grpc.ServerStreamingServer[AccountIndex]) error {
	return status.Errorf(codes.Unimplemented, "method GetPrePreCooldownAccounts not implemented")
}
...
func (UnimplementedQueriesServer) GetConsensusDetailedStatus(context.Context, *ConsensusDetailedStatusQuery) (*ConsensusDetailedStatus, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetConsensusDetailedStatus not implemented")
}
...
func _Queries_GetScheduledReleaseAccounts_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(BlockHashInput)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(QueriesServer).GetScheduledReleaseAccounts(m, &grpc.GenericServerStream[BlockHashInput, AccountPending]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Queries_GetScheduledReleaseAccountsServer = grpc.ServerStreamingServer[AccountPending]

func _Queries_GetCooldownAccounts_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(BlockHashInput)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(QueriesServer).GetCooldownAccounts(m, &grpc.GenericServerStream[BlockHashInput, AccountPending]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Queries_GetCooldownAccountsServer = grpc.ServerStreamingServer[AccountPending]

func _Queries_GetPreCooldownAccounts_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(BlockHashInput)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(QueriesServer).GetPreCooldownAccounts(m, &grpc.GenericServerStream[BlockHashInput, AccountIndex]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Queries_GetPreCooldownAccountsServer = grpc.ServerStreamingServer[AccountIndex]

func _Queries_GetPrePreCooldownAccounts_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(BlockHashInput)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(QueriesServer).GetPrePreCooldownAccounts(m, &grpc.GenericServerStream[BlockHashInput, AccountIndex]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Queries_GetPrePreCooldownAccountsServer = grpc.ServerStreamingServer[AccountIndex]
...
func _Queries_GetConsensusDetailedStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConsensusDetailedStatusQuery)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueriesServer).GetConsensusDetailedStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Queries_GetConsensusDetailedStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueriesServer).GetConsensusDetailedStatus(ctx, req.(*ConsensusDetailedStatusQuery))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Queries_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetConsensusDetailedStatus",
			Handler:    _Queries_GetConsensusDetailedStatus_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetScheduledReleaseAccounts",
			Handler:       _Queries_GetScheduledReleaseAccounts_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "GetCooldownAccounts",
			Handler:       _Queries_GetCooldownAccounts_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "GetPreCooldownAccounts",
			Handler:       _Queries_GetPreCooldownAccounts_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "GetPrePreCooldownAccounts",
			Handler:       _Queries_GetPrePreCooldownAccounts_Handler,
			ServerStreams: true,
		},
		{
